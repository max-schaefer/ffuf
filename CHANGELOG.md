...
- master
  ...
  - Changed
    ...
    - Fix raw request parsing (-request) to honour non-canonical Host headers (e.g. lowercase `host:` from HTTP/2 captures), which previously produced a URL with an empty host
